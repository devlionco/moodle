...
/**
 * Testing the upgrade of mlnlpessay question attempts.
 *
...
class upgrade_old_attempt_data_test extends \question_attempt_upgrader_test_base {
    ...
    public function test_mlnlpessay_deferredfeedback_history98220() {
        $quiz = (object) array(
            'id' => '4140',
            'course' => '5012',
    ...
    public function test_mlnlpessay_deferredfeedback_history820() {
        $quiz = (object) array(
            'id' => '142',
            'course' => '187',
            'name' => 'Questionnaire',
    ...
    public function test_mlnlpessay_deferredfeedback_missing() {
        $quiz = (object) array(
            'id' => '142',
            'course' => '187',
            'name' => 'Questionnaire',
