 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_mlnlpessay_restore_testcase extends restore_date_testcase  {

    /**
     * Test missing qtype_mlnlpessay_options creation.
     *
     * Old backup files may contain essays with no qtype_mlnlpessay_options record.
    ...
    public function test_restore_create_missing_qtype_mlnlpessay_options() {
        ...
        $DB->delete_records('qtype_mlnlpessay_options', ['questionid' => $essay->id]);
        ...
        $this->assertTrue($DB->record_exists('qtype_mlnlpessay_options', ['questionid' => $newessay->id]));
    }
}
