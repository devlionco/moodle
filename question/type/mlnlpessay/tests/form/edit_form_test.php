...
require_once($CFG->dirroot . '/question/type/mlnlpessay/edit_mlnlpessay_form.php');

/**
 * Unit tests for the mlnlpessay edit form.
 *
...
class edit_form_test extends \advanced_testcase {
    ...
    public function test_attachments_validation(int $allowed, int $required, array $expected): void {
        list($form, $category) = $this->get_form('qtype_mlnlpessay_edit_form');
        $submitteddata = [
    ...
    public function user_preference_provider(): array {
        $valid = [];
        $invalid = ['attachmentsrequired' => get_string('mustrequirefewer', 'qtype_mlnlpessay')];
        return [
