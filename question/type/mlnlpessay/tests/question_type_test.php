...
use qtype_mlnlpessay;

defined('MOODLE_INTERNAL') || die();

global $CFG;
require_once($CFG->dirroot . '/question/type/mlnlpessay/questiontype.php');


/**
 * Unit tests for the mlnlpessay question type class.
 *
...
class question_type_test extends \advanced_testcase {
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'mlnlpessay');
    }
