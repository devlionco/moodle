...
Feature: In an mlnlpessay question, let the question author choose the min/max number of words for input text
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | mlnlpessay | mlnlpessay-min-max | editor   | 0            | 0            |

  Scenario: Minimum/Maximum word limit are enabled but not set.
    When I am on the "mlnlpessay-min-max" "core_question > edit" page logged in as teacher
