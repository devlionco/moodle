...
Feature: In a mlnlpessay question, limit submittable file types
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | mlnlpessay       | TF1   | First question  | 20          |
  ...
  Scenario: Preview an mlnlpessay question and submit a response with a correct filetype.
  ...
  @javascript @_file_upload
  Scenario: Preview an mlnlpessay question and try to submit a response with an incorrect filetype.
    When I log in as "student"
    And I follow "Manage private files"
