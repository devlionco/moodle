...
/**
 * Provides the information to backup mlnlpessay questions
 *
 * @copyright  2010 onwards Eloy Lafuente (stronk7) {@link http://stronk7.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_qtype_mlnlpessay_plugin extends backup_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        $plugin = $this->get_plugin_element(null, '../../qtype', 'mlnlpessay');
        ...
        $mlnlpessay->set_source_table('qtype_mlnlpessay_options',
