 ...
 *
 * Note, there are already lots of tests of the diagnostic type in the behaviour
 * tests. (Search for test_question_maker::make_a_diagnostic.) This file only
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_diagnostic_walkthrough_test extends qbehaviour_walkthrough_test_base {
    public function test_deferredfeedback_feedback_diagnostic_single() {

        // Create a diagnostic, single question.
        $mc = test_question_maker::make_a_diagnostic_single_question();
    ...
    public function test_deferredfeedback_feedback_diagnostic_multi() {
        // Create a diagnostic, multi question.
        $mc = test_question_maker::make_a_diagnostic_multi_question();
        $mc->shuffleanswers = false;
