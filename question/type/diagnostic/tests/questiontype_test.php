...
require_once($CFG->dirroot . '/question/type/diagnostic/questiontype.php');
require_once($CFG->dirroot . '/question/type/edit_question_form.php');
require_once($CFG->dirroot . '/question/type/diagnostic/edit_diagnostic_form.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_diagnostic_test extends advanced_testcase {
    protected $qtype;

    protected function setUp() {
        $this->qtype = new qtype_diagnostic();
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'diagnostic');
    }
    ...
    public function test_question_saving_two_of_four($which) {
        ...
        $questiondata = test_question_maker::get_question_data('diagnostic', $which);
        $formdata = test_question_maker::get_question_form_data('diagnostic', $which);

        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category(array());

        $formdata->category = "{$cat->id},{$cat->contextid}";
        qtype_diagnostic_edit_form::mock_submit((array)$formdata);

        $form = qtype_diagnostic_test_helper::get_question_editing_form($cat, $questiondata);
