...
require_once($CFG->dirroot . '/question/type/gapselectmath/questiontypebase.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_gapselectmath extends qtype_gapselectmath_base {
    protected function choice_options_to_feedback($choice) {
        return $choice['choicegroup'];
    }

    protected function make_choice($choicedata) {
        return new qtype_gapselectmath_choice($choicedata->answer, $choicedata->feedback);
    }
    ...
    public function import_from_xml($data, $question, qformat_xml $format, $extra=null) {
        if (!isset($data['@']['type']) || $data['@']['type'] != 'gapselectmath') {
            return false;
        }
