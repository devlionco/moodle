@qtype @qtype_gapselectmath @_switch_window
Feature: Test all the basic functionality of this question type
  ...
  create and preview gapselectmath (Select missing words) questions.
  ...
  @javascript
  Scenario: Create, edit then preview a gapselectmath question.
