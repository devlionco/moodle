 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_gapselectmath_test extends question_testcase {
    /** @var qtype_gapselectmath instance of the question type class to test. */
    protected $qtype;

    protected function setUp() : void {
        $this->qtype = question_bank::get_qtype('gapselectmath');
    }
    ...
    public function test_save_question() {
        ...
        $fromform = test_question_maker::get_question_form_data('gapselectmath', 'missingchoiceno');
        $fromform->category = $category->id . ',' . $syscontext->id;

        $question = new stdClass();
        $question->category = $category->id;
        $question->qtype = 'gapselectmath';
     ...
     * {@link test_question_maker::make_question('gapselectmath')}.
     */
    protected function get_test_question_data() {
        return test_question_maker::get_question_data('gapselectmath');
    }

    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'gapselectmath');
    }
    ...
    public function test_initialise_question_instance() {
        ...
        $expected = test_question_maker::make_question('gapselectmath');
    ...
    public function test_xml_import() {
        $xml = '  <question type="gapselectmath">
    <name>
    ...
    <hint format="moodle_auto_format">
      ...
      <clearwrong />
        ...
        $q = $importer->try_importing_using_qtypes(
                $xmldata['question'], null, null, 'gapselectmath');

        $expectedq = new stdClass();
        $expectedq->qtype = 'gapselectmath';
