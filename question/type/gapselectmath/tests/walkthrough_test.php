...
/**
 * This file contains tests that simulate a user attempt a gapselectmath question.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_gapselectmath_walkthrough_test extends qbehaviour_walkthrough_test_base {
    public function test_interactive_behaviour() {

        // Create a gapselectmath question.
        $q = test_question_maker::make_question('gapselectmath');
        $q->hints = array(
    ...
    public function test_multilang_behaviour() {
        ...
        // Create a multilang gapselectmath question.
        $q = test_question_maker::make_question('gapselectmath', 'multilang');
        $q->shufflechoices = false;
        $this->start_attempt_at_question($q, 'interactive', 3);
    ...
    public function test_choices_containing_dollars() {
        ...
        $q = test_question_maker::make_question('gapselectmath', 'currency');
        $q->shufflechoices = false;
