...
/**
 * Test helpers for the calcsheet question type.
 *
 * @package    qtype_calcsheet
...
/**
 * Test helper class for the calcsheet question type.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_calcsheet_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('frogtoad', 'frogonly', 'escapedwildcards');
    }

    /**
     * Makes a calcsheet question with correct ansewer 'frog', partially
     * correct answer 'toad' and defaultmark 1. This question also has a
     * '*' match anything answer.
     * @return qtype_calcsheet_question
     */
    public function make_calcsheet_question_frogtoad() {
        question_bank::load_question_definition_classes('calcsheet');
        $sa = new qtype_calcsheet_question();
        ...
        $sa->qtype = question_bank::get_qtype('calcsheet');

        return $sa;
    }

    /**
     * Gets the question data for a calcsheet question with with correct
     * ansewer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_calcsheet_question_data_frogtoad() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'calcsheet';
    ...
    /**
     * Makes a calcsheet question with just the correct ansewer 'frog', and
     * no other answer matching.
     * @return qtype_calcsheet_question
     */
    public function make_calcsheet_question_frogonly() {
        question_bank::load_question_definition_classes('calcsheet');
        $sa = new qtype_calcsheet_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'Short answer question';
    ...
    /**
     * Gets the question data for a calcsheet questionwith just the correct
     * ansewer 'frog', and no other answer matching.
     * @return stdClass
     */
    public function get_calcsheet_question_data_frogonly() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);
     ...
     * @return qtype_calcsheet_question
     */
    public function make_calcsheet_question_escapedwildcards() {
        question_bank::load_question_definition_classes('calcsheet');
        $sa = new qtype_calcsheet_question();
        test_question_maker::initialise_a_question($sa);
