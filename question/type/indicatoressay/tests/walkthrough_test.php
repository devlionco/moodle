...
/**
 * Unit tests for the indicatoressay question type.
 *
...
class walkthrough_test extends \qbehaviour_walkthrough_test_base {
    ...
    public function test_deferred_feedback_html_editor() {
        ...
        // Create an indicatoressay question.
        $q = \test_question_maker::make_question('indicatoressay', 'editor');
    ...
    public function test_deferred_feedback_plain_text() {
        ...
        // Create an indicatoressay question.
        $q = \test_question_maker::make_question('indicatoressay', 'plain');
        $this->start_attempt_at_question($q, 'deferredfeedback', 1);
    ...
    public function test_responsetemplate() {
        ...
        // Create an indicatoressay question.
        $q = \test_question_maker::make_question('indicatoressay', 'responsetemplate');
        $this->start_attempt_at_question($q, 'deferredfeedback', 1);
    ...
    public function test_deferred_feedback_html_editor_with_files_attempt_on_last() {
        ...
        // Create an indicatoressay question in the DB.
        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category();
        $question = $generator->create_question('indicatoressay', 'editorfilepicker', array('category' => $cat->id));
    ...
    public function test_deferred_feedback_plain_attempt_on_last() {
        ...
        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category();
        $question = $generator->create_question('indicatoressay', 'plain', array('category' => $cat->id));
    ...
    public function test_deferred_feedback_word_limits() {
        ...
        // Create an indicatoressay question.
        /** @var qtype_indicatoressay_question $q */
        $q = \test_question_maker::make_question('indicatoressay', 'editor');
        $q->minwordlimit = 3;
        $q->maxwordlimit = 7;
        $this->start_attempt_at_question($q, 'deferredfeedback', 1);
