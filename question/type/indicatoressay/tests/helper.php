...
/**
 * Test helpers for the indicatoressay question type.
 *
...
/**
 * Test helper class for the indicatoressay question type.
 *
 * @copyright  2013 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_indicatoressay_test_helper extends question_test_helper {
     ...
     * @return qtype_indicatoressay_question
     */
    protected function initialise_essay_question() {
        question_bank::load_question_definition_classes('indicatoressay');
        $q = new qtype_indicatoressay_question();
        test_question_maker::initialise_a_question($q);
        $q->name = 'Indicatoressay question (HTML editor)';
        ...
        $q->qtype = question_bank::get_qtype('indicatoressay');

        return $q;
    }

    /**
     * Makes an indicatoressay question using the HTML editor as input.
     * @return qtype_indicatoressay_question
     */
    ...
    /**
     * Make the data what would be received from the editing form for an indicatoressay
    ...
    public function get_essay_question_form_data_editor() {
        ...
        $fromform->name = 'Indicatoressay question (HTML editor)';
    ...
    /**
     * Makes an indicatoressay question using the HTML editor allowing embedded files as
    ...
    public function get_essay_question_form_data_editorfilepicker() {
        ...
        $fromform->name = 'Indicatoressay question with filepicker and attachments';
        $fromform->questiontext = array('text' => 'Please write a story about a frog.', 'format' => FORMAT_HTML);
        $fromform->defaultmark = 1.0;
        $fromform->generalfeedback = array('text' => 'I hope your story had a beginning, a middle and an end.', 'format' => FORMAT_HTML);
    ...
    /**
     * Makes an indicatoressay question using plain text input.
     * @return qtype_indicatoressay_question
     */
    ...
    /**
     * Makes an indicatoressay question using monospaced input.
     * @return qtype_indicatoressay_question
     */
    ...
    /**
     * Makes an indicatoressay question without an online text editor.
     * @return qtype_indicatoressay_question
     */
