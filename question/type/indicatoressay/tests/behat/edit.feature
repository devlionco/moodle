...
Feature: Test editing an Indicatoressay question
  As a teacher
  In order to be able to update my Indicatoressay question
  I need to edit them
  ...
  Scenario: Edit an Indicatoressay question
    ...
    And I set the following fields to these values:
      | Question name   | Edited indicatoressay-001 name |
    ...
    And I press "id_submitbutton"
    Then I should see "Edited indicatoressay-001 name"
