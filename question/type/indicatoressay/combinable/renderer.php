...
require_once($CFG->dirroot . '/question/type/indicatoressay/renderer.php');

class qtype_indicatoressay_embedded_renderer extends qtype_combined_text_entry_renderer_base {
...
.que.combined textarea.qtype_indicatoressay_response {
    width: 100%;
}

.que.combined textarea.qtype_indicatoressay_response.qtype_indicatoressay_plain {
    white-space: pre-wrap;
    font: inherit;
}

.que.combined .qtype_indicatoressay_response.qtype_indicatoressay_monospaced {
    white-space: pre;
    font-family: Andale Mono, Monaco, Courier New, DejaVu Sans Mono, monospace;
}

.que.combined .qtype_indicatoressay_response {
    min-height: 3em;
}

.que.combined .qtype_indicatoressay_response.readonly {
    background-color: white;
}

.que.combined div.qtype_indicatoressay_response textarea {
    width: 100%;
}
</style>
STYLE;
        ...
        if($feedbackenable){
            $result .= html_writer::tag('div', get_string('waitteacherreview', 'qtype_indicatoressay'),
