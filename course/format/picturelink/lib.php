 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_picturelink extends core_courseformat\base {
    ...
    public function course_format_options($foreditform = false) {
        ...
        $course = $this->get_course();
        if ($courseformatoptions === false) {  // added picturelinkimage options  hanna 24/6/2020
            ...
            $courseformatoptions = array(
                ...
                'picturelinkimage_defaultstat' => array(
                    'default' => '',
                    'type' => PARAM_RAW,
                ),
                'picturelinkimage_completed' => array(
                    'default' => '',
                    'type' => PARAM_RAW,
                ),
                'picturelinkimage_locked' => array(
                    'default' => '',
                    'type' => PARAM_RAW,
                ),
                'picturelinkimage_hiden' => array(
                    'default' => '',
                    'type' => PARAM_RAW,
                ),
    ...
    // added options for status images  hanna 24/6/2020
            $courseformatoptionsedit = array(
                ...
                'picturelinkimage_defaultstat' => array(
                    'label' => new lang_string('picturelinkimage_defaultstat_form_label', 'format_picturelink'),
                    'element_type' => 'filemanager',
                    'element_attributes' => array(
                    ),
                ),
                'picturelinkimage_completed' => array(
                    'label' => new lang_string('picturelinkimage_completed_form_label', 'format_picturelink'),
                    'element_type' => 'filemanager',
                    'element_attributes' => array(
                    ),
                ),
                'picturelinkimage_locked' => array(
                    'label' => new lang_string('picturelinkimage_locked_form_label', 'format_picturelink'),
                    'element_type' => 'filemanager',
                    'element_attributes' => array(
                    ),
                ),
                'picturelinkimage_hiden' => array(
                    'label' => new lang_string('picturelinkimage_hiden_form_label', 'format_picturelink'),
                    'element_type' => 'filemanager',
                    'element_attributes' => array(
                    ),
                ),
    ...
    // added above secs for image statuses: default, completed, locked, hiden  hanna 24/6/2020
    ...
    public function create_edit_form_elements(&$mform, $forsection = false) {
        ...
        // course module status images...
        //  add secs for statuses images: picturelinkimage_completed, defaultstat, locked, hiden  hanna 24/6/2020
        $picturelinkimage_defaultstat_draftid = file_get_submitted_draft_itemid('picturelinkimage_defaultstat');
        file_prepare_draft_area($picturelinkimage_defaultstat_draftid, $context->id, 'format_picturelink', 'picturelinkimage_defaultstat', $COURSE->id,
            array('subdirs' => false));
        $mform->setDefault('picturelinkimage_defaultstat', $picturelinkimage_defaultstat_draftid);

        $picturelinkimage_completed_draftid = file_get_submitted_draft_itemid('picturelinkimage_completed');
        file_prepare_draft_area($picturelinkimage_completed_draftid, $context->id, 'format_picturelink', 'picturelinkimage_completed', $COURSE->id,
            array('subdirs' => false));
        $mform->setDefault('picturelinkimage_completed', $picturelinkimage_completed_draftid);

        $picturelinkimage_locked_draftid = file_get_submitted_draft_itemid('picturelinkimage_locked');
        file_prepare_draft_area($picturelinkimage_locked_draftid, $context->id, 'format_picturelink', 'picturelinkimage_locked', $COURSE->id,
            array('subdirs' => false));
        $mform->setDefault('picturelinkimage_locked', $picturelinkimage_locked_draftid);

        $picturelinkimage_hiden_draftid = file_get_submitted_draft_itemid('picturelinkimage_hiden');
        file_prepare_draft_area($picturelinkimage_hiden_draftid, $context->id, 'format_picturelink', 'picturelinkimage_hiden', $COURSE->id,
            array('subdirs' => false));
        $mform->setDefault('picturelinkimage_hiden', $picturelinkimage_hiden_draftid);
    ...
    public function update_course_format_options($data, $oldcourse = null) {
        ...
        file_save_draft_area_files($data->picturelinkimage_defaultstat, $context->id, 'format_picturelink', 'picturelinkimage_defaultstat',
            $course->id, array('subdirs' => 0, 'maxbytes' => $maxbytes, 'maxfiles' => 1));
        file_save_draft_area_files($data->picturelinkimage_completed, $context->id, 'format_picturelink', 'picturelinkimage_completed',
            $course->id, array('subdirs' => 0, 'maxbytes' => $maxbytes, 'maxfiles' => 1));
        file_save_draft_area_files($data->picturelinkimage_locked, $context->id, 'format_picturelink', 'picturelinkimage_locked',
            $course->id, array('subdirs' => 0, 'maxbytes' => $maxbytes, 'maxfiles' => 1));
        file_save_draft_area_files($data->picturelinkimage_hiden, $context->id, 'format_picturelink', 'picturelinkimage_hiden',
            $course->id, array('subdirs' => 0, 'maxbytes' => $maxbytes, 'maxfiles' => 1));
    // todo add secs for statuses images: picturelinkimage_completed, defaultstat, locked, hiden  hanna 24/6/2020
