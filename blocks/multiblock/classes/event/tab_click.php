...
namespace block_multiblock\event;
defined('MOODLE_INTERNAL') || die();

/**
 * Abstract Tab clicked event.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tab_click extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' click on tab ".$this->other['title']." , block_".$this->other['type'];
    }
    ...
    public static function get_name() {
        return get_string('eventtabclick', 'block_multiblock');
    }
