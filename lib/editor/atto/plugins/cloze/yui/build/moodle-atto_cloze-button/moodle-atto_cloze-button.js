...
// along with Moodle.  If not, see <http://www.gnu.org/licenses/>.
    ...
    Y.namespace('M.atto_cloze').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
        ...
        _getDialogueContent: function(e, qtype) {
            var template, content, direction;
            ...
            content = Y.Node.create(template({CSS: CSS,
                ...
                math: (this._qtype === 'SHORTANSWER_MATH'),
                direction: direction
            }));
            ...
            if(this._qtype === 'SHORTANSWER_MATH') {
                content.delegate('input', this._mathliveInput, 'math-field', this);
            }
        ...
        /**
         * Change in mathlive input.
         *
         * @method _mathliveInput
         * @param {Event} e Event from button click
         * @private
         */
        _mathliveInput: function(e) {
            e.preventDefault();

            var data = e.target.getData();

            var mf = document.getElementById('math_' + data.mathid);
            this._form.all('#' + data.mathid + '_answer').set('value', mf.getValue());
        },
