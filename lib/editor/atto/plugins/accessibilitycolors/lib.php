...
function atto_accessibilitycolors_render_navbar_output() {
    global $PAGE;

    $PAGE->requires->js_amd_inline('require(["jquery", "atto_accessibilitycolors/tinycolor"], function($, tinycolor) {M.tinycolor =  tinycolor});');
    return;
}
 ...
 */
function atto_accessibilitycolors_params_for_js($elementid, $options, $fpoptions) {

    $availablecolors = get_config('atto_accessibilitycolors', 'availablecolors');
    ...
    $availablecolorsbackground = get_config('atto_accessibilitycolors', 'availablecolorsbackground');
 ...
 */
function atto_accessibilitycolors_strings_for_js() {
    global $PAGE;
