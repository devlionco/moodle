@editor @editor_atto @atto @atto_accessibilitycolors
Feature: Atto more font background colours button
  ...
  Background:
    ...
    Given the following config values are set as admin:
      | toolbar         | style1 = bold, accessibilitycolors | editor_atto         |
      | availablecolors | #123456 #654321               | atto_accessibilitycolors |
  ...
  Scenario: Change colour of some text
    ...
    When I click on ".atto_accessibilitycolors_button" "css_element"
    Then ".atto_accessibilitycolors_button.atto_menu" "css_element" should be visible
    And "//div[@data-color='#123456']" "xpath_element" should exist in the ".atto_accessibilitycolors_button.atto_menu" "css_element"
    And "//div[@data-color='#654321']" "xpath_element" should exist in the ".atto_accessibilitycolors_button.atto_menu" "css_element"
