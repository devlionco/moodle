...
$string['accessibility_policy'] = 'מסמך להצהרת נגישות';
$string['accessibility_policy_link_descr'] = '';
...
$string['showless'] = 'פחות';
$string['showmore'] = 'יותר';
...
$string['user_loginas'] = 'התחבר כתלמיד זה';
