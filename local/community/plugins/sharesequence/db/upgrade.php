 ...
 * @return bool result
 */
function xmldb_community_sharesequence_upgrade($oldversion) {
    ...
    if ($oldversion < 2020110824) {
        ...
        $DB->delete_records('local_metadata_field', ['contextlevel' => \local_metadata\mcontext::section()->get_contextid()]);
