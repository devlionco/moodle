 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class upload_sequence_to_catalog extends moodleform {
    ...
    public function definition() {
        ...
        foreach ($sharesequence->get_required_fields() as $item) {
            $this->build_element($item, $default);
        }

        $shownonrequieredfields = get_config('community_sharesequence', 'shownonrequieredfields');
        $notrequiredfields = $sharesequence->get_not_required_fields();
        if (!empty($notrequiredfields)) {
            if ($shownonrequieredfields == 1) {
                $html = '<button class="btn btn-primary mb-2" type="button" data-toggle="collapse" data-target="#collapseNotRequired"
                    ...
                    ' . get_string('advanced_catalog_options', 'community_sharesequence') . '                
                </button>
    ...
    public function build_element($item, $default) {
        ...
        switch ($item->datatype) {
            ...
            // Not standart types.
            case 'selectsections':
                $html = $OUTPUT->render_from_template('community_sharesequence/elements/section-competency-block-wrapper', []);
                $mform->addElement('html', $html);
                break;
            ...
            case 'durationactivity':
                ...
                $html = $OUTPUT->render_from_template('community_sharesequence/elements/radio-duration', $item);
                $mform->addElement('html', $html);
                break;
            ...
            case 'levelactivity':
                ...
                $html = $OUTPUT->render_from_template('community_sharesequence/elements/radio-buttons-row-difficalty', $item);
                $mform->addElement('html', $html);
                break;
            ...
            case 'originality':
                ...
                $html = $OUTPUT->render_from_template('community_sharesequence/elements/radio-buttons-column', $item);
                $mform->addElement('html', $html);
                break;

            case 'tags':
                $html = $OUTPUT->render_from_template('community_sharesequence/elements/tags', $item);
                $mform->addElement('html', $html);
                break;

            // Standart types.
            case 'fileupload':
                $html = $OUTPUT->render_from_template('community_sharesequence/elements/form-item', $item);
            ...
            case 'text':
                ...
                $html = $OUTPUT->render_from_template('community_sharesequence/elements/input', $item);
                $mform->addElement('html', $html);
                break;
            ...
            case 'multiselect':
                if ($item->multiselecttype == 'single') {
                    ...
                    $html = $OUTPUT->render_from_template('community_sharesequence/elements/radio-buttons-row', $item);
                    $mform->addElement('html', $html);
                }
                ...
                if ($item->multiselecttype == 'multi') {
                    ...
                    $html = $OUTPUT->render_from_template('community_sharesequence/elements/checkbox-buttons', $item);
                    $mform->addElement('html', $html);
                }
                break;
            ...
            case 'checkbox':
                ...
                $html = $OUTPUT->render_from_template('community_sharesequence/elements/checkbox', $item);
                $mform->addElement('html', $html);
                break;
        }
    }
