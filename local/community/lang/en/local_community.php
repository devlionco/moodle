...
$string['settingsinsertmails'] = 'Mails';
$string['settingsinsertmailsdesc'] = 'Insert mails via comma';
$string['mail_subject_add_activity'] = "New activity added to repository";
$string['mail_subject_add_activity_existmid'] = 'New activity added to repository with similar MID={$a}';
