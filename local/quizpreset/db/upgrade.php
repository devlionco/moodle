...
function xmldb_local_quizpreset_upgrade($oldversion) {
    ...
    if ($oldversion < 2019072720) {

        if (!$dbman->table_exists('local_quizpreset_mystates')) {
            $table = new xmldb_table('local_quizpreset_mystates');

            $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
            $table->add_field('userid', XMLDB_TYPE_INTEGER, '10', null, null, null, null);
            $table->add_field('typename', XMLDB_TYPE_TEXT, 'long', null, null, null, null);
            $table->add_field('settings', XMLDB_TYPE_TEXT, 'long', null, null, null, null);
        ...
        upgrade_plugin_savepoint(true, 2019072720, 'local', 'quizpreset');
    }
