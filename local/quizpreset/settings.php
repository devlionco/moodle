...
if ($hassiteconfig) {
    ...
    for ($i = 1; $i <= $numtypes; $i++) {
        ...
        $title = new lang_string('quiztype_description_admin', 'local_quizpreset', $i);
        $description = '';
        $default = '';
        $setting = new admin_setting_configtextarea($name, $title, $description, $default, PARAM_TEXT);
        $settings->add($setting);

        $name = 'local_quizpreset/quiztypedescriptionstudent_' . $i;
        $title = new lang_string('quiztype_description_student', 'local_quizpreset', $i);
        $description = '';
        $default = '';
        $setting = new admin_setting_configtextarea($name, $title, $description, $default, PARAM_TEXT);
        $settings->add($setting);
