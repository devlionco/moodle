...
$string['describe_physics_1'] =
        'The most rigorous assignment in the student submits the assignment without receiving feedback on its performance. The student is given only one opportunity to complete the assignment when a club can be set up to complete the assessment.';
$string['describe_physics_2'] =
        'The assignment will not be given to students. During the assignment after answering the question, students will see the correct answer and can correct their answer to complete the task successfully.';
...
$string['describe_chemistry_2'] =
        'The student has one experience. When done, he will see the points he received and the questions he made, but not the correct answer. The answers will be revealed to students after the exam completion date - requires the exam date completion date.';
$string['describe_chemistry_3'] =
        'There is no limit to the number of attempts, the questions appear one after another in the center, the student sees his mistakes, the score and the correct answer already at the end of the answer in the first attempt. Suitable for pre-test practice of tests that have already been done in homework format. These exam scores will not enter the student\'s grades page. (Duplicate exams are recommended to keep the original grades)';
$string['describe_chemistry_4'] =
        'In homework, the student receives 3 attempts to answer the examiner, the score being the highest of attempts made (reduces the chance of copying in homework). The questions appear one after the other. After submitting the exam, the student sees the mistakes he made and the grade but not the correct answer. Each student\'s experience is based on his or her predecessor, and students will be able to view the correct answers after the exam completion date - requiring the exam completion date.';
...
$string['quiztype_description_admin'] = 'Type {$a} description for teacher';
$string['quiztype_description_student'] = 'Type {$a} description for student';
...
$string['mypresetenable'] = 'My preset enable';
$string['defaulttypename'] = 'My preset';
$string['buttonsavemypreset'] = 'Save my preset';

$string['titlepopuppreset'] = 'Data of my preset';
$string['save'] = 'Save';
$string['labelpresetname'] = 'Name of preset';
$string['placeholderpresetname'] = 'Enter name of preset';
$string['labelteacherdescription'] = 'Description for teacher';
$string['placeholderteacherdescription'] = 'Enter description for teacher';
$string['labelstudentdescription'] = 'Description for student';
$string['placeholderstudentdescription'] = 'Enter description for student';
