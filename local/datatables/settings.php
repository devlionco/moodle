...
$category = new admin_category('localdatatables', 'Datatables');
...
// various pages.
$category->add('localdatatables', new admin_externalpage('datatables_test',
                                                    "Datatables " . get_string('test', 'local_datatables'),
                                                    "$CFG->wwwroot/local/datatables/test.php"));
