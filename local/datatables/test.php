 ...
 *
 * @package		local_datatables
 * @copyright	2015 Frederick C. Yankowski
 * @license		http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace local_datatables;
...
$page = '';
$recordsperpage = 9999;
$users = get_users(true, 'student', false, array(), 'lastname ASC',
...
$title = get_string('pluginname', 'local_datatables');
...
$selector = '.datatable';
$PAGE->requires->js_call_amd('local_datatables/init', 'init', array($selector, $params));
...
$renderer = $PAGE->get_renderer('local_datatables');
