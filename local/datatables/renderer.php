...
class local_datatables_renderer extends \plugin_renderer_base {
    /**
    ...
    public function test($data) {
        ...
        $out = $this->output->heading(get_string('Users', 'local_datatables'));
        $out .= $this->output->render_from_template("local_datatables/test", $data);
        return $out;
    }
}
