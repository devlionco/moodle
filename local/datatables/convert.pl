...
while (<>) {
    # convert dependency from 'datatables' to 'local_datatables/jquery.dataTables'
    s@define\((\s*)\['jquery',(\s*)'datatables\.net'\]@define(['jquery','local_datatables/jquery.dataTables']@g;
