...
class send_uncompleted_reminders extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('tasks:send_uncompleted_reminders', 'local_tutorials');
    }
    ...
    public function execute() {
        $task = new \local_tutorials\task\adhoc_send_reminders_to_users();
