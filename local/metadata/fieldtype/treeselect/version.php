...
/**
 * Metadata treeselect fieldtype plugin version info.
 *
 * @package metadatafieldtype_fileupload
...
$plugin->component = 'metadatafieldtype_treeselect'; // Full name of the plugin (used for diagnostics).
