...
$string['contexttitle'] = 'קורס';
$string['metadatatitle'] = 'מידע־מורחב לקורס';
$string['metadatadisabled'] = 'מידע־מורחב לקורס אינו זמין כעת.';
$string['metadataenabled'] = 'שימוש בשדות מידע־מורחב בקורסים';
$string['pluginname'] = 'מידע־מורחב לקורס';
