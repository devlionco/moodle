@local @local_metadata @metadatacontext @metadatacontext_section
Feature: Enable section context plugin
  In order to use metadata for sections
  As an admin
  I need to enable metadata for sections

  @javascript
  Scenario: Enable metadata for sections
    ...
    And I set the field "id_s_metadatacontext_section_metadataenabled" to "1"
    And I press "Save changes"
    Then the field "s_metadatacontext_section_metadataenabled" matches value "1"
    ...
    And I press "Save changes"
    Then I should see "System sections"
    And I should see "Question One"
    And I click on "Edit" "link" in the "//table[@id='sections']//tr[1]//td[6]" "xpath_element"
