...
class h5p_paused extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('pausedactionevent', 'local_h5ptracker');
    }
    ...
    public function get_description() {
        return 'User ' . $this->relateduserid . ' clicked pause button in cmid ' . $this->objectid;
    }
