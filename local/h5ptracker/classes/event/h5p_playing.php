...
class h5p_playing extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('playingactionevent', 'local_h5ptracker');
    }
    ...
    public function get_description() {
        return 'User ' . $this->relateduserid . ' clicked play button in cmid ' . $this->objectid;
    }
