...
$string['passwordwasreset'] = 'You have just reset user {$a->username} password to: {$a->password}';
$string['confirmmessage'] = 'You are about to reset user {$a} password. Are you sure?';
$string['resetstudentpassword'] = 'Student password reset';
$string['roster:resetpassword'] = 'Reset user password';