...
Feature: Notification popover unread notifications
  ...
  Background:
    # This will make sure petel notifications are enabled and create
    ...
    Given the following "courses" exist:
      ...
      | Course 1 | C1 | 0 | 1 |
    # Make sure the petel notifications are enabled for assignments.
    And the following config values are set as admin:
      | petel_provider_mod_assign_assign_notification_permitted | permitted | message |
      | message_provider_mod_assign_assign_notification_loggedin | petel | message |
      | message_provider_mod_assign_assign_notification_loggedoff | petel | message |
