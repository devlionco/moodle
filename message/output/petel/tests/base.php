...
trait message_petel_test_helper {
     ...
     */
    protected function send_fake_unread_petel_notification($userfrom, $userto, $message = 'Hello world!', $timecreated = 0) {
        global $DB;
     ...
     * @return int the id of the message
     */
    protected function send_fake_read_petel_notification($userfrom, $userto, $message = 'Hello world!',
        ...
        $petel = new stdClass();
        $petel->notificationid = $record->id;
        $DB->insert_record('message_petel_notifications', $petel);
