 ...
 *
 * @module     message_petel/notification_repository
...
define(['core/ajax', 'core/notification'], function(Ajax, Notification) {
    ...
    var query = function(args) {
        ...
        var request = {
            methodname: 'message_petel_get_petel_notifications',
            args: args
        };
    ...
    var countUnread = function(args) {
        var request = {
            methodname: 'message_petel_get_unread_petel_notification_count',
            args: args
        };
