...
require_once('sms_validation_form.php');

//HTTPS is required in this page when $CFG->loginhttps enabled
//$PAGE->https_required();

$PAGE->set_url('/login/sms_validation.php');
$systemcontext = context_system::instance();
$PAGE->set_context($systemcontext);

// Setup text strings.
$strforgotten = get_string('smsvalidation', 'theme_petel');
...
core_login_sms_validation_request();